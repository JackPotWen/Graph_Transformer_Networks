...
def main():
    ...
    parser.add_argument('--out_dir', type=str, default='F:/github/Graph_Transformer_Networks/all_attempt/PE_HeGraph_With_GT/LaPe/results', help='输出目录')
    ...
    data, edge_types = prepare_heterogeneous_data(args.data_path, add_lap_pos_enc, pos_enc_dim)
