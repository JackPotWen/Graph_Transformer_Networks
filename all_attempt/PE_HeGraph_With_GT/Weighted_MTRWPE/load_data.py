...
def prepare_heterogeneous_data(data_path="F:/github/Graph_Transformer_Networks/data/DBLP", 
                             ...
                             add_metapath2vec_pe=False, metapath2vec_pe_path=None):
    """
    准备异构图数据的完整流程
    ...
    if add_metapath2vec_pe and metapath2vec_pe_path:
        data = add_metapath2vec_positional_encoding(data, metapath2vec_pe_path)
