...
def get_default_net_params(device, in_dim, n_classes):
    ...
    net_params = {
        ...
        'metapath2vec_pe_path': 'F:/github/Graph_Transformer_Networks/metapath2vec_including_edge_weight/original_metapath2vec/experiment_result/vec_feature.pkl',  # metapath2vec PE路径
...
def main():
    ...
    parser.add_argument('--out_dir', type=str, default='F:/github/Graph_Transformer_Networks/all_attempt/PE_HeGraph_With_GT/Weighted_MTRWPE/results', help='输出目录')
    ...
    metapath2vec_pe_path = temp_net_params.get('metapath2vec_pe_path', None)
    ...
    data, edge_types = prepare_heterogeneous_data(
        ...
        metapath2vec_pe_path=metapath2vec_pe_path
    )
