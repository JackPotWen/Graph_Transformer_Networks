...
def visualize_embeddings(embeddings, labels=None, save_path=None, perplexity=30, n_iter=1000, 
    ...
    title = 'Node Embeddings Visualization (t-SNE) - ACM Dataset\n'
...
def main():
    # 设置命令行参数
    parser = argparse.ArgumentParser(description='使用t-SNE进行ACM数据集节点嵌入可视化')
    ...
    parser.add_argument('--save_path', type=str, 
                        default='/home/kuei-jan/github/Graph_Transformer_Networks/metapath2vec_including_edge_weight/original_metapath2vec/ACM/node_embeddings_tsne_PAP.png',
                        help='输出图片保存路径')
