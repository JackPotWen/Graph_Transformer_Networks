...
def train_metapath2vec(args):
    ...
    # 加载数据
    print("正在加载数据...")
    edge_index_dict, num_nodes_dict = load_dblp_data(args.data_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='data/DBLP/edges.pkl',
                        help='DBLP 数据集路径')
    parser.add_argument('--save_dir', type=str, default='experiment_result',
                        help='保存结果的目录')
    parser.add_argument('--embedding_dim', type=int, default=334,
                        help='嵌入维度')
